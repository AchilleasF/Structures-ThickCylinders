### Linear elastic stress analysis of shear-flexible cylinder under normal pressure
...
abaqus.sigmaphi_i = abaqus.p_S11_top; abaqus.sigmaphi_m = (abaqus.p_S11_bot+abaqus.p_S11_top)/2; abaqus.sigmaphi_o = abaqus.p_S11_bot
abaqus.sigmatheta_i = abaqus.p_S22_top; abaqus.sigmatheta_m = (abaqus.p_S22_bot+abaqus.p_S22_top)/2; abaqus.sigmatheta_o = abaqus.p_S22_bot
...
########################
plt.close('all')
# Normal pressure u displacement profile
plt.figure(1)
plt.grid()
...
abaqusline, = plt.plot(-abaqus.p_U2*1e5, abaqus.zinv,color=black,linestyle='none',linewidth=0.5*LW,marker='o',markersize=MS,markerfacecolor='white',markevery=4)
plt.gca().invert_yaxis()
plt.legend([thickline,thinline,abaqusline],['Thick theory','Thin theory','ABAQUS FE'],loc='lower left', fontsize=FS, frameon=True, edgecolor=black)
plt.xlabel('$u\cdot 10^{-5}$ [mm]',fontdict={'size':FS})
plt.ylabel('Axial coordinate $z$ [mm]',fontdict={'size':FS})

# Normal pressure displacement profile
plt.figure(2)
plt.grid()
...
abaqusline, = plt.plot(abaqus.p_U1*1e6, abaqus.zinv,color=black,linestyle='none',linewidth=0.5*LW,marker='o',markersize=MS,markerfacecolor='white',markevery=4)
plt.gca().invert_yaxis()
plt.legend([thickline,thinline,abaqusline],['Thick theory','Thin theory','ABAQUS FE'],loc='center right', fontsize=FS, frameon=True, edgecolor=black)
plt.xlabel('$w\cdot 10^{-6}$ [mm]',fontdict={'size':FS})
plt.ylabel('Axial coordinate $z$ [mm]',fontdict={'size':FS})

# Normal pressure meridional stress patterns sigma_phi
plt.figure(3)
plt.grid()
...
# Normal pressure circumferential stress patterns sigma_theta
plt.figure(4)
plt.grid()
...
plt.gca().invert_yaxis()
plt.legend([thickline,thinline,abaqusin,abaqusmid,abaqusout],['Thick theory','Thin theory','ABAQUS FE (inner surf.)','ABAQUS FE (middle surf.)','ABAQUS FE (outer surf.)'],loc='center right', fontsize=FS, frameon=True, edgecolor=black)
